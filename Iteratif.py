...
def search_anomaly(player_name, stats_list, suspected_cheaters):
    """
    Fungsi untuk mencari pemain tertentu dalam daftar statistik dan memeriksa anomali mereka.

    Parameters:
    player_name (str): Nama pemain yang akan diperiksa.
    stats_list (list): Daftar statistik semua pemain, contoh:
        [
...
anomaly_result = search_anomaly(player_name, stats_list, suspected_cheaters)
